...
class HockeyPlayer{
	...
	//constructors
	public HockeyPlayer(String lastName, String position, String birthplace, int number){
	...
	public HockeyPlayer(HockeyPlayer hp){
		this(hp.lastName, hp.position, hp.birthplace, hp.number);
	}
...
class Goalie extends HockeyPlayer{
	...
	@Override
	public String toString(){
		return String.format("%-15s | %-15s | %-14s | %-10d | %-14f | %-16f | %-14tF %n", super.toString(), getPosition(), gamesPlayed, wins, saveP, avgWinsGP, date);	
	}
}
...
class Skater extends HockeyPlayer{
	...
	@Override 
	public String toString(){
		return String.format("%-15s | %-15s | %-14s | %-10d | %-14f | %-16f | %-14tF %n", super.toString(), getPosition(), gamesPlayed, points, shotP, avgPtsGP, date);	
	}
}
...
class Roster{
	...
	public void setRoster2018(){
		HockeyPlayer ek  = new HockeyPlayer("Kuznetsov", "Center", "Russia", 92);
		//hp, gp, pts, shots, goals
		Skater ek2018 = new Skater(ek, 22, 26, 59, 7);
		
		HockeyPlayer ab = new HockeyPlayer("Burakovsky", "Left Wing", "Austria", 65);
		Skater ab2018 = new Skater(ab, 28, 8, 34, 5);
			
		HockeyPlayer tw = new HockeyPlayer("Wilson", "Right Wing", "Canada", 43);
		Skater tw2018 = new Skater(tw, 11, 14, 26, 8);
		
		HockeyPlayer bh = new HockeyPlayer("Holtby", "Goalie", "Canada", 70);
		//hp, gp, wins, shotsAg, saves
		Goalie bh2018 = new Goalie(bh, 20, 10, 616, 559);
			
		HockeyPlayer jc = new HockeyPlayer("Carlson", "Defense", "USA", 74);
		Skater jc2018 = new Skater(jc, 27, 29, 69, 5);
			
		HockeyPlayer ao = new HockeyPlayer("Ovechkin", "Left Wing", "Russia", 8);
		Skater ao2018 = new Skater(ao, 28, 34, 107, 21);
			
		HockeyPlayer pc = new HockeyPlayer("Copley", "Goalie", "USA", 1);
		Goalie pc2018 = new Goalie(pc, 10, 6, 276, 249);
			
		HockeyPlayer mb = new HockeyPlayer("Bowey", "Defense", "Canada", 22);
		Skater mb2018 = new Skater(mb, 19, 5, 17, 0);
			
		HockeyPlayer nb = new HockeyPlayer("Backstrom", "Center", "Sweden", 19);
		Skater nb2018 = new Skater(nb, 28, 34, 61, 10);
			
		HockeyPlayer to = new HockeyPlayer("Oshie", "Right Wing", "USA", 77);
		Skater to2018 = new Skater(to, 18, 14, 40, 9);
		
		HockeyPlayer test = new HockeyPlayer("TEST", "Goalie", "Italy", 15);
		Goalie test2018 = new Goalie(test, 5, 4, 79, 75);
		
		HockeyPlayer dor = new HockeyPlayer("Orlov", "Defense", "Russia", 9);
		Skater dor2018 = new Skater(dor, 28, 10, 38, 2);
		
		HockeyPlayer jv = new HockeyPlayer("Vrana", "Left Wing", "Czech Republic", 13);
		Skater jv2018 = new Skater(jv, 28, 17, 50, 9);
...
public class DataTableV5{
	...
	public static void main(String... args){
		DataTableV5 dt = new DataTableV5();
		dt.userOptions();
	}
}